...
<p class="caption">Figure 1: Figure 1 Phishing activity trend in 2020. (Source: APWG Phishing Activity Trends Report)</p>
</div>
...
<p class="caption">Figure 2: Figure 2 Project Pipeline of Phishing Detection Machine Learning Model</p>
</div>
...
<p class="caption">Figure 3: Figure 3 Example features of ‘ratio_nullHyperlinks' showing only single value for label, and 'brand_in_subdomain’ showing very low frequency positive label</p>
</div>
...
<p class="caption">Figure 4: Table 4: Pair-wise correlation of top correlated features</p>
</div>
...
<p class="caption">Figure 5: Figure 4: Feature ‘nb_slash’ before (left) and after (right) standardization</p>
</div>

<div class="figure" style="text-align: left">
<img src="images/Picture5.png" alt="Figure 5: Feature ‘geolocation’ before (left) and after (right) re-binning" width="100%" />
<p class="caption">Figure 6: Figure 5: Feature ‘geolocation’ before (left) and after (right) re-binning</p>
</div>
...
<p class="caption">Figure 7: Figure 6: Test performance across all models and sampling strategies</p>
</div>
...
<p class="caption">Figure 8: Figure 7: Feature Importance Scores of the Chosen Random Forest Model</p>
</div>
...
<p class="caption">Figure 9: Appendix 1: Feature Importance Graph of Chosen Random Forest Model (1:1 Downsampled)</p>
</div>
