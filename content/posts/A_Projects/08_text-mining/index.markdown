...
<p class="caption">Figure 4: Skip-gram model architecture and example</p>
</div>
...
<p class="caption">Figure 5: Using Gensim to find the most similar words</p>
</div>
...
<p class="caption">Figure 19: Distrbution of sentiment - Reddit users are largely neutrals</p>
</div>
...
<p class="caption">Figure 20: Likert scale time series from oldest (bottom) to newest (top)</p>
</div>
